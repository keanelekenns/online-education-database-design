# online-education-database-design
...
![ER diagram for online education database](./ERDiagram.PNG)

## SQL

This is a script for creating, populating, and demonstrating use cases for the database. It can be run in a postgreSQL server. The \echo statements can be uncommented for a verbose output.
